...
class GettextScanner
{
    ...
    public function createPoFile($lines = array())
    {
        if (count($lines) < 1) {
            return false;
        }
        ...
        if (file_exists($this->fileName)) {
            ...
            $read = fopen($this->fileName, "r") or die("can't open the file");
            while (!feof($read)) {
        ...
        $file = fopen($this->fileName, 'a+') or die('Could bot open file ' . $this->fileName);
        $headMetadata = 'msgid ""
msgstr ""
"Project-Id-Version: Loveria\n"
"Language-Team: \n"
"Language: fr\n"
"MIME-Version: 1.0\n"
