   ...
   public function updateUserProfile(Request $request){
    ...
    public function viewAllResultSearch(Request $request)
    {
        ...
        // } else {
            ...
            $processReaction['data']['search_data'] = $search_data;
            $processReaction['data']['totalCount'] = count($search_data);
    ...
    public function getLikeView()
    {
        ...
        $page = request()->input('page');
        //get mutual like data
        $processReaction = $this->userEngine->prepareLikeData();
        $current_user_favourite = $this->userEngine->prepareUserFavouriteData(1);
        $current_user_mutual_like = $this->userEngine->prepareMutualLikeData();
    ...
    public function frind_profile_data(Request $request){
            ...
            if (isset($processReaction['data'])) {
               ...
               if (isset($processReaction['data']['userOnlineStatus'])) {
                ...
                if (isset($processReaction['data']['userSpecificationTexts']['looking_for'])) {
            
                $looking_for = $processReaction['data']['userSpecificationTexts']['looking_for'];
                } else {
                    $looking_for = "";
                }
                
                if (isset($processReaction['data']['userSpecificationTexts']['kinks'])) {            
                $kinks = $processReaction['data']['userSpecificationTexts']['kinks'];
                }else{
                    $kinks = "";
                }

                if (isset($processReaction['data']['userSpecificationTexts']['body_type'])) {
                $body_type = $processReaction['data']['userSpecificationTexts']['body_type'];            
                } else {
                    $body_type = "";
                }
                
                if (isset($processReaction['data']['userSpecificationTexts']['hair_color'])) {
                $hair_color = $processReaction['data']['userSpecificationTexts']['hair_color'];            
                } else {
                    $hair_color = "";
                }

                if (isset($processReaction['data']['userSpecificationTexts']['ethnicity'])) {
                $ethnicity = $processReaction['data']['userSpecificationTexts']['ethnicity'];            
                } else {
                    $ethnicity = "";
                }
                
                if (isset($processReaction['data']['userSpecificationTexts']['height'])) {            
                $height = $processReaction['data']['userSpecificationTexts']['height'];
                } else {
                    $height = "";
                }

                if ($processReaction['data']['userSpecificationTexts']['eye_color']) {
                $eye_color = $processReaction['data']['userSpecificationTexts']['eye_color'];            
                } else {
                   $eye_color = "";
                }
                
                if (isset($processReaction['data']['userSpecificationTexts']['smoke'])) {
                $smoke = $processReaction['data']['userSpecificationTexts']['smoke'];            
                } else {
                    $smoke = "";
                }
                
                if (isset($processReaction['data']['userSpecificationTexts']['drink'])) {
                $drink = $processReaction['data']['userSpecificationTexts']['drink'];            
                } else {
                   $drink = "";
                }
