    ...
    public function frind_profile_data(Request $request){
            ...
            if (isset($processReaction['data'])) {
               ...
               if (isset($processReaction['data']['userOnlineStatus'])) {
                ...
                $response_layout .= "<div class='profile-icon d-flex'><div class='profile-icon-left-side d-flex'>";
                $response_layout .= "<div class='main-heart' id='user-".$userId ."'><a href data-action='".route('user.write.like_dislike', ['toUserUid' => $userUId, 'like' => 1])."' data-method='post' data-callback='onLikeCallback' title='Like' class='icon lw-ajax-link-action lw-like-action-btn' id='lwLikeBtn'>";
                if ($like_sts == 1) { 
