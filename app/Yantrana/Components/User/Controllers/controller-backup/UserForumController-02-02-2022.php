...
use App\Yantrana\Components\ForumTopics\Requests\{ManageForumTopicsAddRequest, ManageForumTopicsEditRequest,ManageForumTopicReplyRequest};
...
class UserForumController extends BaseController
{
    ...
    public function viewAllForumResultSearch(Request $request)
    {
        ...
        return $this->loadSearchView('filter.view-all-forum-results', $processReaction['data']);
