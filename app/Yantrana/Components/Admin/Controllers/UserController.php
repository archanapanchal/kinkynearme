...
namespace App\Yantrana\Components\Admin\Controllers;
...
class UserController extends BaseController
{
    ...
    public function loginProcess(UserLoginRequest $request)
    {
        ...
        if ($processReaction['reaction_code'] === 1) {
            ...
            // Redirect forcefully to admin dashboard
            $processReaction['data']['intendedUrl'] = '';
    ...
    public function signUpProcess(UserSignUpRequest $request)
    {
        ...
        if ($processReaction['reaction_code'] === 1) {
            return $this->responseAction(
                $this->processResponse($processReaction, [], [], true),
                $this->redirectTo('admin.user.login')
            );
        } else {
            return $this->responseAction(
                $this->processResponse($processReaction, [], [], true)
    ...
    public function changePasswordView()
    {
        ...
        return $this->loadPublicView('admin.change-password', $data);
    }
    ...
    public function changeEmailView()
    {
        ...
        return $this->loadPublicView('admin.change-email', $data);
    }
    ...
    {
        return $this->loadView('admin.forgot-password');
    }
    ...
    public function processForgotPassword(UserForgotPasswordRequest $request)
    {
        ...
        if ($processReaction['reaction_code'] === 1) {
            return $this->responseAction(
                $this->processResponse($processReaction, [], [], true),
                $this->replaceView('admin.forgot-password-success', [], '.lw-success-message')
            );
        } else {
            return $this->responseAction(
                $this->processResponse($processReaction, [], [], true)
    ...
    public function accountActivation(Request $request, $userUid)
    {
        ...
        if ($processReaction['reaction_code'] === 1) {
            return redirect()->route('admin.admin.user.login')
                ->with([
                    'success' => 'true',
    ...
    {
        return $this->loadPublicView('admin.change-email-success');
    }
    ...
    {
        return $this->loadManageView('admin.reset-password');
    }
    ...
    public function processRestPassword(
        ...
        if ($processReaction['reaction_code'] === 1) {
            return $this->responseAction(
                $this->processResponse($processReaction, [], [], true),
                $this->redirectTo('admin.admin.user.login')
            );
        } else {
            return $this->responseAction(
                $this->processResponse($processReaction, [], [], true)
    ...
    public function getUserProfile($userName)
    {
        ...
        return $this->loadPublicView('admin.profile', $processReaction['data']);
    }
    ...
    public function getMyLikeView()
    {
        ...
        //load default view
        return $this->loadPublicView('admin.my-liked', $processReaction['data']);
    }
    ...
    public function getMyDislikedView()
    {
        ...
        //load default view
        return $this->loadPublicView('admin.my-disliked', $processReaction['data']);
    }
    ...
    public function getWhoLikedMeView()
    {
        ...
        //load default view
        return $this->loadPublicView('admin.who-liked-me', $processReaction['data']);
    }
    ...
    public function getMutualLikeView()
    {
        ...
        if (!is_null($page) and ($page != 1)) {
            ...
            $processReaction['data'] = view('admin.partial-templates.my-liked-users', $processReaction['data'])
                ->render();
        ...
        //load default view
        return $this->loadPublicView('admin.mutual-like', $processReaction['data']);
    }
