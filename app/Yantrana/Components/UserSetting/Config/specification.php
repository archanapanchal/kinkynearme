    ...
    'groups' => [
        'step-1' => [
            ...
            'items' => [
                ...
                'Sexual preference' => [
                    'name'          => __tr('sexual-preference'),
                    'input_type'    => 'dynamic',
                    'options' => [
                        'bi-comfortable'    => __tr('Bi Comfortable'),
                        'bi-curious'        => __tr('Bi Curious'),
                        'bisexual'          => __tr('Bisexual'),
                        'gay'               => __tr('Gay'),
                        'lesbian'           => __tr('Lesbian'),
                        'open minded'       => __tr('Open Minded'),
                        'straight'          => __tr('Straight'),
                    ]
                ],
                'our_sexual_orientation' => [
                    'name'          => __tr('Our sexual orientation'),
                    'input_type'    => 'select',
                    //'multiple'      => true,
                    'options' => [
                        'bi-comfortable'    => __tr('Bi Comfortable'),
            ...
            'items' => [
                ...
                'children' => [
                    ...
                    'options' => [
                        'yes'       => __tr('Yes'),
                        'no'        => __tr('No'),
                        'prefer_not_to_say' => __tr('Prefer not to say')
