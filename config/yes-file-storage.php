...
return [
    ...
    'element_config' => [
        ...
        'favicon'    => [
            'restrictions' => [
                'allowedFileTypes'  => ['image/ico', 'image/vnd.microsoft.icon']
            ]
        ],
        'footer_logo'    => [
            'restrictions' => [
        ...
        'forum_images'    => [
            'restrictions' => [
                'allowedFileTypes'  => ['image/jpg', 'image/JPG', 'image/jpeg', 'image/JPEG','image/png', 'image/PNG', 'image/svg', 'image/svg+xml']
            ]
        ],
    ],
