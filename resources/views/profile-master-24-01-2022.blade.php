            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if($active_tab == 1) active @endif" href="<?= route('user.read.find_matches') ?>" role="tab">Find people near me</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if($active_tab == 6) active @endif" data-toggle="tab" href="#tabs-5" role="tab">Discussion forum</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if($active_tab == 1) active @endif" href="#" role="tab"style="pointer-events:none;">Find people near me</a>
                        </li>
                        <li class="nav-item">
