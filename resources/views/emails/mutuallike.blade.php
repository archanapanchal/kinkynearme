	...
	<tbody>
		...
		<tr style="font-family: Helvetica, Arial, sans-serif;">
			<td class="free-text" style="border-collapse: collapse; color: #777777; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; padding: 10px 60px 0px; text-align: left; width: 100% !important;">
					<?= e($FromUserName) ?> has liked your profile and its a match and start messaging with your mutually liked profiles.
			</td>
		</tr>
		<tr style="font-family: Helvetica, Arial, sans-serif;">
			<td class="free-text" style="border-collapse: collapse; color: #777777; font-family: Helvetica, Arial, sans-serif; font-size: 14px; line-height: 21px; padding: 10px 60px 0px; text-align: left; width: 100% !important;">
					Please visit <a href="<?= e($PageURL) ?>" target="_blank"> Mutual Like Page </a> to check the profile.
			</td>
		</tr>
	</tbody>
</table>