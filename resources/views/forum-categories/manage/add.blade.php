@section('forum-category-title', __tr("Add Forum Category"))
@section('head-title', __tr("Add Forum Category"))
@section('keywordName', strip_tags(__tr("Add Forum Category")))
@section('keyword', strip_tags(__tr("Add Forum Category")))
@section('description', strip_tags(__tr("Add Forum Category")))
@section('keywordDescription', strip_tags(__tr("Add Forum Category")))
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-200"><?= __tr('Add Forum Category')  ?></h1>
	<!-- back button -->
