...
<div class="col-lg-3 mb-5 load-matches" id="user-<?= $user['id'] ?>">
        ...
        <div class="profile-desc">
            ...
            <div class="profile-icon d-flex">
                <div class="profile-icon-left-side d-flex">
                    ...
                    <div class="main-star">
                        <a href data-action="<?= route('user.write.favourite', ['toUserUid' => $user['_uid'], 'favourite' => 1]) ?>" data-method="post" data-callback="onFavouriteCallback" title="Favourite" class="icon lw-ajax-link-action lw-favourite-action-btn" id="lwFavouriteBtn">
