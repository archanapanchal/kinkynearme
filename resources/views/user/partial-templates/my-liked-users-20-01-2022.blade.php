            ...
            <div class="profile-icon d-flex">
                <div class="profile-icon-left-side d-flex">
                    <div class="main-heart">
                        <a href data-action="<?= route('user.write.like_dislike', ['toUserUid' => $user['user_uid'], 'like' => 1]) ?>" data-method="post" data-callback="onLikeCallback" title="Like" class="icon lw-ajax-link-action lw-like-action-btn" id="lwLikeBtn">

                            <?php 
                            if (in_array($user['user_id'],$current_user_mutual_like_ids)) { ?>
                    ...
                    <div class="main-star">
                        <a href data-action="<?= route('user.write.favourite', ['toUserUid' => $user['user_uid'], 'favourite' => 1]) ?>" data-method="post" data-callback="onFavouriteCallback" title="Favourite" class="icon lw-ajax-link-action lw-favourite-action-btn" id="lwFavouriteBtn">
