...
?>
<div class="col-lg-3 mb-5 load-matches" id="user-<?= $user['user_id'] ?>">
            ...
            <div class="profile-icon d-flex">
                <div class="profile-icon-left-side d-flex">
                    <div class="main-heart">
                        <a href data-action="<?= route('user.write.like_dislike', ['toUserUid' => $user['user_id'], 'like' => 1]) ?>" data-method="post" data-callback="onLikeCallback" title="Like" class="icon lw-ajax-link-action lw-like-action-btn" id="lwLikeBtn">
                    ...
                    <div class="main-star">
                        <a href data-action="<?= route('user.write.favourite', ['toUserUid' => $user['user_uid'], 'favourite' => 1]) ?>" data-method="post" data-callback="onFavouriteCallback" title="Favorite" class="icon lw-ajax-link-action lw-favourite-action-btn" id="lwFavouriteBtn">

                            <?php 
                            if (in_array($user['user_id'],$current_user_favourite_ids)) { ?>
...
<div id="lwNextPageLink" class="col-sm-12 col-md-12 col-lg-12">
    <a href="" class="btn btn-light btn-block lw-ajax-link-action" data-method="get" data-callback="loadNextLikedUsers"></a>
</div>
@else
@endIf -->