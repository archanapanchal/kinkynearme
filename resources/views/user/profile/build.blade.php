...
<section class="complete-form-section">
    <div class="com-inner">
        <div class="com-header">
            <h2><?= __tr('LET’S BUILD YOUR PROFILE') ?></h2>
                    ...
                    <div class="form-card">
                        @foreach(collect($specifications['items'])->chunk(2) as $specification)                        
                            ...
                            <div class="form-field">
                                ...
                                @else
                                    <div class="select-input buld_profile_kinky">
                                        <?php 
                                        if ($item['name'] == "kinks") { 
                                            $item['multiple'] = true;
                                            ?>
                                            <select multiple="multiple" name="<?= $item['multiple'] == true ? $item['name'] . '[]' : $item['name'] ?>" class="multiple-kinks" <?= $item['multiple'] == true ? 'multiple' : '' ?>>
