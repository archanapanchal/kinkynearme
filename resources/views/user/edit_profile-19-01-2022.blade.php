              ...
              <div class="edit-pic">
                 ...
                 <div class="select-bar">
                    ...
                    <div class="form-field">
                       ...
                       <div class="field-input">
                          <input type="text" name="userName" placeholder="sheridankuhn" value="<?= $userData['userName'] ?>">
                       </div>
                    </div>
                    <div class="form-field">
                       ...
                       @foreach(collect($userSpecificationData['step-1']['items'])->chunk(2) as $specification) 
                           @foreach($specification as $itemKey => $item)
                                   @if($item['name'] == 'ethnicity')
                                       <select name="ethnicity" class="form-control-user lw-user-gender-select-box" id="select_gender" required>
