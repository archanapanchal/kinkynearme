	...
	<div class="tab-pane active" id="tabs-6" role="tabpanel">
        <div class="my-account">
            ...
            @endif
                                                        ...
                                                        @foreach(collect($userSpecificationData['step-1']['items'])->chunk(2) as $specification) 
                                                            @foreach($specification as $itemKey => $item)
                                                                @if($item['name'] == 'kinks')
                                                                    ...
                                                                    ?>
                                                                    <?= str_replace(['"','[',']'], '', $item['selected_options']) ?>
                                                                @endif
                                                            @endforeach
                                                        @endforeach
                                                    @endif
                ...
                <div id="manage-pass" class="tabcontent form-login">
                                            ...
                                            @foreach($planList as $type => $plan)
                                                ...
                                                <form  class="subscription-border">
                                                        ...
                                                        <div class="subscription-plan-desc">
                                                            ...
                                                            <input type="hidden" id="section_amount" name="amount" value="<?= $plan['price'] ?>" />
                                            ...
                                            <form id="paymentForm" method="POST" action="{{ url('charge') }}" style="display:none">
                                                {{ csrf_field() }}
                                                    ...
                                                    <button type="button"
                                                                ...
                                                                data-acceptUIFormHeaderTxt="Card Information Note: To maintain discretion, your payment will appear as 'KNM Media LLC' on your billing statement."
                                        ...
                                        <div class="row mobile-hide">
                                            ...
                                            <form  class="subscription-border">
                                                        ...
                                                        <div class="subscription-plan-desc">
                                                            ...
                                                            <input type="hidden" id="section_amount_choose" name="amount" value="<?= $plan['price'] ?>" />
               ...
               <div id="blocked-profiles" class="tabcontent">
               ...
               <div id="delete-profile" class="tabcontent">
...
<script type="text/javascript">
    ...
    $(".select_plan").on("click",function(){
        var section_amount = $(this).prev().prev().prev( "#section_amount" ).val();
        var section_plan = $(this).prev().prev( "#section_plan" ).val();
        var section_plan_name = $(this).prev( "#section_plan_name" ).val();
    ...
    $(".select_plan_choose").on("click",function(){
        var section_amount = $(this).prev().prev().prev( "#section_amount_choose" ).val();
        var section_plan = $(this).prev().prev( "#section_plan_choose" ).val();
        var section_plan_name = $(this).prev( "#section_plan_name_choose" ).val();
