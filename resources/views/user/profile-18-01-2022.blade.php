                                    ...
                                    <div class="card-body">
                                        <div class="row mobile-hide">
                                            @foreach($planList as $type => $plan)
                                                ...
                                                <form id="paymentForm" method="POST" action="{{ url('charge') }}" class="subscription-border">
                                                            {{ csrf_field() }}
                            ...
                            <div id="pane_b-<?= $type ?>" class="card tab-pane fade @if ($i == 0) show active @endif" role="tabpanel" aria-labelledby="tab-<?= $type ?>">
                                ...
                                <div id="collapse-<?= $type ?>" class="collapse @if ($i == 0) show @endif" data-parent="#content" role="tabpanel" aria-labelledby="heading-<?= $type ?>">
                                    ...
                                    <div class="card-body">
                                        <div class="row mobile-hide">
                                            @foreach($planList as $type => $plan)
                                            <form action="#" class="subscription-border">
                                                {{ csrf_field() }}
                                                <div class="subscription-plan-desc">
                                                    <h2 class="heading-title"><?= strtoupper($plan['title']) ?></h2>
                                                    <?php 
                                                        ...
                                                        <input type="hidden" name="cc_number" value="370000000000002" />
                                                        <input type="hidden" name="expiry_month" value="12" /> 
                                                        <input type="hidden" name="expiry_year" value="26" />
                                                        <input type="hidden" name="cvv" value="365" />   
                                                        <span class="plan_price">$<?= $plan['price'] ?></span>
                                                       <?php  }
                                                    ...
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal_data<?php echo $plan['price'] ?>" data-whatever="@mdo"><?= __tr('PROCEED') ?></button>
                                                    <!-- <input type="submit" name="submit" value="" class="btn btn-primary choose-button" /> -->   
                                                </div>
