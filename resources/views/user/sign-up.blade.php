        ...
        <form class="form-field-fontent user lw-ajax-form lw-form" method="POST" action="<?= route('user.sign_up.process') ?>" data-show-processing="true" data-secured="true" data-unsecured-fields="first_name,last_name">
            <div class="form-row">
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                    <label for="inputAddress"><?= __tr('first Name') ?> (not visible to other members)</label>
            ...
            <div class="form-row">
                <!-- Last Name -->
                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                    <label for="inputAddress"><?= __tr('last Name') ?> (not visible to other members)</label>
            ...
            <div class="form-row">
                <!-- Email Address -->
                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                    <label for="inputAddress"><?= __tr('Email Address') ?> (not visible to other members)</label>
                ...
                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="acceptTerms">
                            <?= __tr('I agree to the ') ?>
                            <a target="_blank" href="{{url('/terms-condition')}}">
