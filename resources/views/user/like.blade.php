@section('page-title', __tr('Likes'))
@section('head-title', __tr('Likes'))
@section('keywordName', __tr('Likes'))
@section('keyword', __tr('Likes'))
@section('description', __tr('Likes'))
@section('keywordDescription', __tr('Likes'))
    ...
    <div class="find-people-tab tab-inner">
		...
		<div class="find-people-profile">
			...
			<div class="alert alert-info">
				<?= __tr('There are no like profile found.') ?>
			</div>
			<!-- / info message -->
			@endif
		</div>
