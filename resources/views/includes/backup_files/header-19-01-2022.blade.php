            ...
            <div class="phy-life-style row">
               <div class="physical-app col-md-6">
                  ...
                  <div class="select-bar row">
                     ...
                     <div class="form-field col-md-6">
                        <label><img src="<?php echo url('/dist/images/app-8.png'); ?>" />Tattoo</label>
                        <div class="select-input">
                           @foreach(collect($userSpecificationData['step-5']['items'])->chunk(2) as $specification) 
		                        @foreach($specification as $itemKey => $item)
                               	@if($item['name'] == 'tattoo')
                                    <select name="tattoo" id="select_gender">
                                        @foreach($item['options'] as $genderKey => $options)
                                        <option value="<?= $genderKey ?>" <?= $item['selected_options'] == $genderKey ? 'selected' : '' ?>><?= $options ?></option>
                                        @endforeach
                                    </select>
                     ...
                     <div class="form-field col-md-6">
                        ...
                        <div class="select-input">
                           @foreach(collect($userSpecificationData['step-5']['items'])->chunk(2) as $specification) 
		                        @foreach($specification as $itemKey => $item)
                               	@if($item['name'] == 'no_of_tattoo')
                                    <select name="no_of_tattoo" id="select_gender">
                                        @foreach($item['options'] as $genderKey => $options)
                                        <option value="<?= $genderKey ?>" <?= $item['selected_options'] == $genderKey ? 'selected' : '' ?>><?= $options ?></option>
                                        @endforeach
                                    </select>
                     ...
                     <div class="form-field col-md-6">
                        <label><img src="<?php echo url('/dist/images/app-9.png'); ?>" />Piercing</label>
                        <div class="select-input">
                           @foreach(collect($userSpecificationData['step-5']['items'])->chunk(2) as $specification) 
		                        @foreach($specification as $itemKey => $item)
                               	@if($item['name'] == 'body_piercing')
                                    <select name="body_piercing" id="select_gender">
                                        @foreach($item['options'] as $genderKey => $options)
                                        <option value="<?= $genderKey ?>" <?= $item['selected_options'] == $genderKey ? 'selected' : '' ?>><?= $options ?></option>
                                        @endforeach
                                    </select>
                     ...
                     <div class="form-field col-md-6">
                        <label>No. of Piercing</label>
                        <div class="select-input">
                           @foreach(collect($userSpecificationData['step-5']['items'])->chunk(2) as $specification) 
		                        @foreach($specification as $itemKey => $item)
                               	@if($item['name'] == 'no_of_piercing')
                                    <select name="no_of_piercing" id="select_gender">
                                        @foreach($item['options'] as $genderKey => $options)
                                        <option value="<?= $genderKey ?>" <?= $item['selected_options'] == $genderKey ? 'selected' : '' ?>><?= $options ?></option>
                                        @endforeach
                                    </select>
