		                           ...
		                           <div class="row align-center">
		                              <div class="col-md-8">
		                                 <div class="advance-search-left d-flex-class">
		                                    <p>Saved Searches</p>
		                                    <div class="city">
		                                       <a href="#">in my city<i class="far fa-trash-alt"></i></a>
		                                       <a href="#">In my state<i class="far fa-trash-alt"></i></a>
		                                    </div>
		                                 </div>
		                              </div>
		                              <div class="col-md-4">
		                           ...
		                           <div class="cty-st-ctry-age-rang row">
		                              <div class="cty-sts-ctry col-md-6">
		                                 ...
		                                 <div class="cty-sts-ctry-btn">
		                                    <div class="city">
		                                       <a href="#">Los Angeles<i class="fa fa-times"></i></a>
		                                       <a href="#">San Fransisco<i class="fa fa-times"></i></a>
