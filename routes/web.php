...
Route::group([
    ...
    // page preview
    Route::get('/page-preview/{pageUId}/{title}', [
        'as' => 'page.preview',
    ...
    Route::get('/{pageId}', [
        'as' => 'page.view',
        'uses' => 'Pages\Controllers\PagesController@pageView',
    ]);
    ...
    Route::group(['middleware' => 'guest'], function () {
        ...
        Route::group([
            ...
            Route::get('/build-profile', [
                'as' => 'user.profile.build',
                'uses' => 'UserController@prepareProfileBuild'
            ]);

            // Get user profile data
            Route::post('/process-profile', [
                'as' => 'user.profile.process',
                'uses' => 'UserController@processProfileBuild'
            ]);

            // Get user profile data
            Route::get('/subscription-plans', [
                'as' => 'user.subscription.plans',
                'uses' => 'UserController@prepareSubscriptionPlans'
            ]);

            Route::post('/subscription_charge', [
                'as' => 'user.subscription_charge',
                'uses' => 'PaymentController@charge'
            ]);

            // Get user profile data
            Route::get('/subscription-plan/{planId}', [
                'as' => 'user.subscription.plan',
                'uses' => 'UserController@prepareSubscriptionPlan'
            ]);

            // Get user profile data
            Route::get('/process-subscription-plan/{planId}', [
                'as' => 'user.subscription.plan.process',
                'uses' => 'UserController@processSubscriptionPlan'
            ]);



            //Route::get('/renew/{sendUserUId}','uses' => 'UserController@renewUserCurrentPlan');
        ...
        Route::group([
            ...
            Route::post('/search-static-cities', [
                'as' => 'user.read.search_static_cities_without_login',
        ...
        Route::group([
            ...
            // forgot password view
            Route::get('/forgot-password', [
                'as' => 'admin.forgot_password',
                'uses' => 'UserController@forgotPasswordView',
            ]);

            // forgot password process
            Route::post('/forgot-password-process', [
                'as' => 'admin.forgot_password.process',
                'uses' => 'UserController@processForgotPassword',
            ]);
            ...
            // reset password process
            Route::post('/reset-password-process/{reminderToken}', [
                'as' => 'admin.reset_password.process',
                'uses' => 'UserController@processRestPassword',
            ]);
        });
    });
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        // Get User Profile view edit
        Route::get('/@{username}/edit_profile', [
            'as' => 'user.edit.profile_view',
            'uses' => 'User\Controllers\UserController@editUserProfile'
        ])->middleware(['admin.redirect']);

        Route::post('/{userUid}/update_profile', [
            'as' => 'user.edit.profile_update',
            'uses' => 'User\Controllers\UserController@updateUserProfile'
        ])->middleware(['admin.redirect']);


        Route::get('/payment', [
            'as' => 'user.payment',
            'uses' => 'User\Controllers\PaymentController@index'
        ])->middleware(['admin.redirect']);


        Route::post('/charge', [
            'as' => 'user.charge',
            'uses' => 'User\Controllers\PaymentController@charge'
        ])->middleware(['admin.redirect']);


        Route::any('user/payment_success', [
            'as' => 'user.payment_success',
            'uses' => 'User\Controllers\PaymentController@payment_success'
        ])->middleware(['admin.redirect']);

        Route::any('user/payment_fail', [
            'as' => 'user.payment_fail',
            'uses' => 'User\Controllers\PaymentController@payment_fail'
        ])->middleware(['admin.redirect']);
        ...
        Route::group([
            ...
            Route::get('user/find-people-near-me', [
                'as' => 'user.read.find_matches',
                'uses' => 'FilterController@getFindMatches',
            ]);

            Route::get('user/search-results', [
                    'as' => 'user.read.search_results',
                    'uses' => 'FilterController@searchResults'
                ]);
        });
        ...
        Route::group([
            ...
            Route::group([
                ...
                Route::get('/view-all-search-results', [
                    'as' => 'user.read.view-search-results',
                    'uses' => 'UserController@viewAllResultSearch'
                ]);
                ...
                // User favourite route
                Route::post('/{toUserUid}/{favourite}/favourite', [
                    'as' => 'user.write.favourite',
                    'uses' => 'UserController@userFavourite'
                ]);
                ...
                Route::get('/favorite', [
                    'as' => 'user.my_favourite_view',
                    'uses' => 'UserController@getMyFavouriteView'
                ]);

                // Get User My favourite view
                Route::get('/who_view_profile', [
                    'as' => 'user.who_view_profile',
                    'uses' => 'UserController@whoViewProfile'
                ]);

                /*Cancel subscription Plan */
                Route::get('/cancel_subscription', [
                    'as' => 'user.cancel.subscription',
                    'uses' => 'UserController@cancelUserCurrentPlan'
                ]);

                Route::get('/create_cookie_flag', [
                    'as' => 'user.create_cookie_flag',
                    'uses' => 'UserController@createCookieFlag'
                ]);

                Route::get('/@{username}/process-soft-delete', [
                    'as' => 'user.soft_delete.profile',
                    'uses' => 'UserController@processUserSoftDelete',
                ]);

                /*renew subscription Plan */
                Route::get('/renew_subscription', [
                    'as' => 'user.renew.subscription',
                    'uses' => 'UserController@renewUserCurrentPlan'
                ]);

                Route::get('/frind_profile_data', [
                    'as' => 'user.frind_profile_data',
                    'uses' => 'UserController@frind_profile_data'
                ]);

                Route::get('/view_profiles_list', [
                    'as' => 'user.view_profiles_list',
                    'uses' => 'UserController@view_profiles_list'
                ]);

                Route::get('/add_user_abuse_report_reason', [
                    'as' => 'user.add_user_abuse_report_reason',
                    'uses' => 'UserController@add_user_abuse_report_reason'
                ]);

                Route::post('/process_add_user_abuse_report_reason', [
                    'as' => 'user.process_add_user_abuse_report_reason',
                    'uses' => 'UserController@process_add_user_abuse_report_reason'
                ]);

                Route::get('/add_block_user_view', [
                    'as' => 'user.add_block_user_view',
                    'uses' => 'UserController@add_block_user_view'
                ]);

                Route::post('/process_add_block_user', [
                    'as' => 'user.process_add_block_user',
                    'uses' => 'UserController@process_add_block_user'
                ]);

                /*users profile setting routs */
                Route::get('/profile_settinig_insert_update', [
                    'as' => 'user.profile_settinig_insert_update.subscription',
                    'uses' => 'UserController@settinig_profile_insert_update'
                ]);
                ...
                Route::get('/like', [
                    'as' => 'user.like',
                    'uses' => 'UserController@getLikeView'
                ]);

                Route::get('/likedyourprofile', [
                    'as' => 'user.like_your_profile',
                    'uses' => 'UserController@getLikeYouView'
                ]);
                ...
                // un-block user
                Route::get('/unblock-user', [
                    'as' => 'user.unblock_user',
                    'uses' => 'UserController@unblockUserFromProfile'
                ]);
                ...
                Route::get('/messages', [
                    'as' => 'user.view.messages',
                    'uses' => 'UserController@messages',
                ]);

                Route::get('/advance-search', [
                    'as' => 'user.advance-search',
                    'uses' => 'UserController@advance_search',
                ]);
                ...
                Route::get('/discussion-forum', [
                    'as' => 'user.view.discussion-forum',
                    'uses' => 'UserForumController@discussionForum',
                ]);

                // Display All Conversation
                Route::post('/create-user-topic', [
                    'as' => 'user.write.create_topic',
                    'uses' => 'UserForumController@createUserTopic',
                ]);

                Route::post('/{forumTopicUId}/update-forum-topic', [
                    'as' => 'user.write.update_topic',
                    'uses' => 'UserForumController@updateUserTopic',
                ]);

                 // forum-topics delete process
                Route::post('/{forumTopicUId}/delete-forum-topic', [
                    'as' => 'user.write.delete_topic',
                    'uses' => 'UserForumController@deleteTopic',
                ]);

                Route::get('/{forumCategoryUId}/all-discussion-forum', [
                    'as' => 'user.view.all-discussion-forum',
                    'uses' => 'UserForumController@allDiscussionForum',
                ]);

                Route::get('/{forumTopicUId}/topic-detail', [
                    'as' => 'user.view.topic-detail',
                    'uses' => 'UserForumController@topicDetail',
                ]);

                Route::post('/reply-to-topic', [
                    'as' => 'user.write.reply-to-topic',
                    'uses' => 'UserForumController@replyToTopic',
                ]);

                Route::post('/increment-user-topic-view-count', [
                    'as' => 'user.write.count-user-forum-topic',
                    'uses' => 'UserForumController@incrementUserForumViewCount',
                ]);

                // Sticker Temp Upload
                Route::post('/upload-forum-temp-media-front', [
                    'as' => 'user.write.upload_temp_media_front',
                    'uses' => 'UserForumController@uploadForumTempMedia',
                ]);

                Route::get('/view-all-search-forum-results', [
                    'as' => 'user.read.forum.view-search-forum-results',
                    'uses' => 'UserForumController@viewAllForumResultSearch'
                ]);

                Route::get('/user-detail-gallery-image', [
                    'as' => 'user.user_detail_gallery_image',
                    'uses' => 'UserController@userDetailGalleryImage'
                ]);
            ...
            Route::group([
                ...
                Route::get('@{username}/delete-profile-image', [
                    'as' => 'user.delete.profile',
                    'uses' => 'UserSettingController@deleteProfileImage'
                ]);

                Route::get('@{username}/delete-portfolio-image', [
                    'as' => 'user.delete.portfolio',
                    'uses' => 'UserSettingController@deletePortfolioImage'
                ]);
                ...
                Route::post('{userid}/upload-photos', [
                    'as' => 'user.upload_photos',
                    'uses' => 'UserSettingController@uploadPhotos'
                ]);
                Route::post('/upload-photo', [
                    'as' => 'user.upload_photos.front',
                    'uses' => 'UserSettingController@uploadPhotosfront'
                ]);

                Route::post('/upload-videos', [
                    'as' => 'user.upload_video',
                    'uses' => 'UserSettingController@uploadVideo'
                ]);

                Route::any('/{video_id}/delete-videos', [
                    'as' => 'user.delete_video',
                    'uses' => 'UserSettingController@deleteVideo'
                ]);
        ...
        Route::group([
            ...
            Route::group([
                ...
                Route::get('/{username}/photos', [
                    'as' => 'user.photos',
                    'uses' => 'ManageUserController@uploadedPhotoList',
                ]);
                ...
                Route::post('/{userUid}/unverify-profile', [
                    'as' => 'manage.user.write.unverify',
                    'uses' => 'ManageUserController@processUnverifyUserProfile',
                ]);
                ...
                // Manage User List
                Route::get('/{status}/export', [
                    'as' => 'manage.user.export',
                    'uses' => 'ManageUserController@userExport',
                ]);
            });
            ...
            Route::group([
                ...
                // Upload Admin Logo
                Route::post('/upload-admin-logo', [
                    'as' => 'media.upload_admin_logo',
                    'uses' => 'MediaController@uploadAdminLogo',
                ]);
                // Upload Favicon
               ...
               // Upload footer Logo
                Route::post('/upload-footer-logo', [
                    'as' => 'media.upload_footer_logo',
                    'uses' => 'MediaController@uploadFooterLogo',
                ]);
                // Sticker Temp Upload
                Route::post('/upload-forum-temp-media', [
                    'as' => 'media.forum.upload_temp_media',
                    'uses' => 'MediaController@uploadForumTempMedia',
                ]);
            });
            ...
            /*
            Kinks Components Manage Section Related Routes
            ------------------------------------------------------------------- */
            Route::group([
                'namespace' => 'Kinks\Controllers',
                'prefix' => 'kinks',
            ], function () {
                // kinks view
                Route::get('/', [
                    'as' => 'manage.kink.view',
                    'uses' => 'ManageKinksController@kinkListView',
                ]);

                // kinks view
                Route::get('/list', [
                    'as' => 'manage.kink.list',
                    'uses' => 'ManageKinksController@getDatatableData',
                ]);

                // kinks add view
                Route::get('/add', [
                    'as' => 'manage.kink.add.view',
                    'uses' => 'ManageKinksController@kinkAddView',
                ]);

                // kinks add process
                Route::post('/kink-add-process', [
                    'as' => 'manage.kink.write.add',
                    'uses' => 'ManageKinksController@processAddKink',
                ]);

                // kinks edit view
                Route::get('/{kinkUId}/edit', [
                    'as' => 'manage.kink.edit.view',
                    'uses' => 'ManageKinksController@kinkEditView',
                ]);

                // kinks edit process
                Route::post('/{kinkUId}/kink-edit-process', [
                    'as' => 'manage.kink.write.edit',
                    'uses' => 'ManageKinksController@processEditKink',
                ]);

                // kinks delete process
                Route::post('/{kinkUId}/kink-delete', [
                    'as' => 'manage.kink.write.delete',
                    'uses' => 'ManageKinksController@delete',
                ]);
            });

            /*
            Plans Components Manage Section Related Routes
            ------------------------------------------------------------------- */
            Route::group([
                ...
                Route::get('/', [
                    'as' => 'manage.plan.view',
                    'uses' => 'ManagePlansController@planListView',
                ]);

                // plans view
                Route::get('/list', [
                    'as' => 'manage.plan.list',
                    'uses' => 'ManagePlansController@getDatatableData',
                ]);

                // plans add view
                Route::get('/add', [
                    'as' => 'manage.plan.add.view',
                    'uses' => 'ManagePlansController@planAddView',
                ]);

                // plans add process
                Route::post('/plan-add-process', [
                    'as' => 'manage.plan.write.add',
                    'uses' => 'ManagePlansController@processAddPlan',
                ]);

                // plans edit view
                Route::get('/{planUId}/edit', [
                    'as' => 'manage.plan.edit.view',
                    'uses' => 'ManagePlansController@planEditView',
                ]);

                // plans edit process
                Route::post('/{planUId}/plan-edit-process', [
                    'as' => 'manage.plan.write.edit',
                    'uses' => 'ManagePlansController@processEditPlan',
                ]);

                // plans delete process
                Route::post('/{planUId}/plan-delete', [
                    'as' => 'manage.plan.write.delete',
                    'uses' => 'ManagePlansController@delete',
                ]);
            });

            /*
            Forum Categories Components Manage Section Related Routes
            ------------------------------------------------------------------- */
            Route::group([
                'namespace' => 'ForumCategories\Controllers',
                'prefix' => 'forum-categories',
            ], function () {
                // forum-categories view
                Route::get('/', [
                    'as' => 'manage.forum-category.view',
                    'uses' => 'ManageForumCategoriesController@forumCategoryListView',
                ]);

                // forum-categories view
                Route::get('/list', [
                    'as' => 'manage.forum-category.list',
                    'uses' => 'ManageForumCategoriesController@getDatatableData',
                ]);

                // forum-categories add view
                Route::get('/add', [
                    'as' => 'manage.forum-category.add.view',
                    'uses' => 'ManageForumCategoriesController@forumCategoryAddView',
                ]);

                // forum-categories add process
                Route::post('/forum-categoryadd-process', [
                    'as' => 'manage.forum-category.write.add',
                    'uses' => 'ManageForumCategoriesController@processAddForumCategory',
                ]);

                // forum-categories edit view
                Route::get('/{forumCategoryUId}/edit', [
                    'as' => 'manage.forum-category.edit.view',
                    'uses' => 'ManageForumCategoriesController@forumCategoryEditView',
                ]);

                // forum-categories edit process
                Route::post('/{forumCategoryUId}/forum-categoryedit-process', [
                    'as' => 'manage.forum-category.write.edit',
                    'uses' => 'ManageForumCategoriesController@processEditForumCategory',
                ]);

                // forum-categories delete process
                Route::post('/{forumCategoryUId}/forum-categorydelete', [
                    'as' => 'manage.forum-category.write.delete',
                    'uses' => 'ManageForumCategoriesController@delete',
                ]);
            });

                
            /*
            Forum Topics Components Manage Section Related Routes
            ------------------------------------------------------------------- */
            Route::group([
                'namespace' => 'ForumTopics\Controllers',
                'prefix' => 'forum-topics',
            ], function () {
                // forum-topics view
                Route::get('/', [
                    'as' => 'manage.forum-topic.view',
                    'uses' => 'ManageForumTopicsController@forumTopicListView',
                ]);

                // forum-topics view
                Route::get('/list', [
                    'as' => 'manage.forum-topic.list',
                    'uses' => 'ManageForumTopicsController@getDatatableData',
                ]);

                // forum-topics add view
                Route::get('/add', [
                    'as' => 'manage.forum-topic.add.view',
                    'uses' => 'ManageForumTopicsController@forumTopicAddView',
                ]);

                // forum-topics add process
                Route::post('/forum-topicadd-process', [
                    'as' => 'manage.forum-topic.write.add',
                    'uses' => 'ManageForumTopicsController@processAddForumTopic',
                ]);

                // forum-topics edit view
                Route::get('/{forumTopicUId}/edit', [
                    'as' => 'manage.forum-topic.edit.view',
                    'uses' => 'ManageForumTopicsController@forumTopicEditView',
                ]);

                // forum-topics edit process
                Route::post('/{forumTopicUId}/forum-topicedit-process', [
                    'as' => 'manage.forum-topic.write.edit',
                    'uses' => 'ManageForumTopicsController@processEditForumTopic',
                ]);

                // forum-topics delete process
                Route::post('/{forumTopicUId}/forum-topicdelete', [
                    'as' => 'manage.forum-topic.write.delete',
                    'uses' => 'ManageForumTopicsController@delete',
                ]);

                Route::get('/{forumTopicUId}/reply', [
                    'as' => 'manage.forum-topic.reply.view',
                    'uses' => 'ManageForumTopicsController@forumTopicReplyListView',
                ]);

                // forum-topics view
                Route::get('/{forumTopicUId}/reply-list', [
                    'as' => 'manage.forum-topic.reply.list',
                    'uses' => 'ManageForumTopicsController@getReplyDatatableData',
                ]);

                Route::post('/{forumTopicReplyUId}/delete-reply', [
                    'as' => 'manage.forum-topic.reply.write.delete',
                    'uses' => 'ManageForumTopicsController@deleteForumTopicReply',
                ]);

                Route::post('/{forumTopicReplyUId}/change-status', [
                    'as' => 'manage.forum-topic.reply.write.change-status',
                    'uses' => 'ManageForumTopicsController@changeReplyStatus',
                ]);
            });


            /*
            Block Countries Components Manage Section Related Routes
            ------------------------------------------------------------------- */
            Route::group([
                'namespace' => 'BlockCountries\Controllers',
                'prefix' => 'block-country',
            ], function () {
                // Block Countries view
                Route::get('/', [
                    'as' => 'manage.blockCountry.view',
                    'uses' => 'ManageBlockCountriesController@blockCountryListView',
                ]);

                // Block Countries view
                Route::get('/list', [
                    'as' => 'manage.blockCountry.list',
                    'uses' => 'ManageBlockCountriesController@getDatatableData',
                ]);

                // Block Countries add view
                Route::get('/add', [
                    'as' => 'manage.blockCountry.add.view',
                    'uses' => 'ManageBlockCountriesController@blockCountryAddView',
                ]);

                // Block Countries add process
                Route::post('/block-country-add-process', [
                    'as' => 'manage.blockCountry.write.add',
                    'uses' => 'ManageBlockCountriesController@processAddBlockCountry',
                ]);

                // Block Countries edit view
                Route::get('/{blockCountryUId}/edit', [
                    'as' => 'manage.blockCountry.edit.view',
                    'uses' => 'ManageBlockCountriesController@blockCountryEditView',
                ]);

                // Block Countries edit process
                Route::post('/{blockCountryUId}/block-country-edit-process', [
                    'as' => 'manage.blockCountry.write.edit',
                    'uses' => 'ManageBlockCountriesController@processEditBlockCountry',
                ]);

                // Block Countries delete process
                Route::post('/{blockCountryUId}/block-country-delete', [
                    'as' => 'manage.blockCountry.write.delete',
                    'uses' => 'ManageBlockCountriesController@delete',
                ]);
            });
        });
    });
