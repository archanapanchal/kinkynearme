! function a(b, c, d) {
    ...
    1: [function(a, b, c) {
        ...
        d = a(2),
            function(a) {
                return a.payform = d, a.payform.fn = {
    ...
    2: [function(a, b, c) {
        ...
        ! function(a, c) {
            ...
            return v = function(a) {
                var b, c, d;
                return null != a.selectionStart ? a.selectionStart : null != document.selection ? (a.focus(), b = document.selection.createRange(), d = a.createTextRange(), c = d.duplicate(), d.moveToBookmark(b.getBookmark()), c.setEndPoint("EndToStart", d), c.text.length) : void 0
            }, u = function(a) {
                return function(b) {
                    return null == b && (b = window.event), b.target = b.target || b.srcElement, b.which = b.which || b.keyCode, null == b.preventDefault && (b.preventDefault = function() {
                ...
                var b, c, d, e;
                for (a = (a + "").replace(/\D/g, ""), e = m.cards, c = 0, d = e.length; d > c; c++)
                ...
                var b;
                return null != ("undefined" != typeof document && null !== document && null != (b = document.selection) ? b.createRange : void 0) && document.selection.createRange().text ? !0 : null != a.selectionStart && a.selectionStart !== a.selectionEnd
            }, o = function(a) {
                var b;
                ...
                var c, d, e, f, g, h, i;
                return e = String.fromCharCode(b.which), !/^\d+$/.test(e) || (i = b.target.value, c = a(i + e), f = (i.replace(/\D/g, "") + e).length, h = 16, c && (h = c.length[c.length.length - 1]), f >= h || (d = v(b.target), d && d !== i.length)) ? void 0 : (g = c && "amex" === c.type ? /^(\d{4}|\d{4}\s\d{6})$/ : /(?:^|\s)(\d{4})$/, g.test(i) ? (b.preventDefault(), setTimeout(function() {
                    return b.target.value = i + " " + e
                })) : g.test(i + e) ? (b.preventDefault(), setTimeout(function() {
                    return b.target.value = i + e + " "
                })) : void 0)
            }, e = function(a) {
                var b, c;
                return c = a.target.value, 8 !== a.which || (b = v(a.target), b && b !== c.length) ? void 0 : /\d\s$/.test(c) ? (a.preventDefault(), setTimeout(function() {
                    return a.target.value = c.replace(/\d\s$/, "")
                })) : /\s\d?$/.test(c) ? (a.preventDefault(), setTimeout(function() {
                ...
                var b, c;
                return b = String.fromCharCode(a.which), /^\d+$/.test(b) ? (c = a.target.value + b, /^\d$/.test(c) && "0" !== c && "1" !== c ? (a.preventDefault(), setTimeout(function() {
                    return a.target.value = "0" + c + " / "
                })) : /^\d\d$/.test(c) ? (a.preventDefault(), setTimeout(function() {
                ...
                var b, c;
                return c = a.target.value, 8 !== a.which || (b = v(a.target), b && b !== c.length) ? void 0 : /\d\s\/\s$/.test(c) ? (a.preventDefault(), setTimeout(function() {
                ...
                var c, d, e;
                return d = String.fromCharCode(b.which), /^\d+$/.test(d) && !k(b.target) ? (e = (b.target.value + d).replace(/\D/g, ""), c = a(e), c && e.length > c.length[c.length.length - 1] ? b.preventDefault() : e.length > 16 ? b.preventDefault() : void 0) : void 0
            }, s = function(a) {
                var b, c;
